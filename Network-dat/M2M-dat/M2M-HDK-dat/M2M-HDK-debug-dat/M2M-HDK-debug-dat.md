...
- [[USB-SDK-dat]] 
    - try USB debug, AT command port, GPS port, modem port, etc. to check if the module is working properly.
...
- [[serial-dat]] 
    ...
    - set the on-board [[logic-level-shifter-dat]] to 5V or 3.3V according to the module's working voltage, or set to NC to try
    - use a [[serial-USB-debugger-dat]], try 5V power supply, all of our boards test in this by default 
