...
![](2026-07-23-20-45-23.png)

将元件印有丝印文字的平面朝向自己，四根引脚从左到右依次编号 1、2、3、4：


引脚序号	引脚名称	功能说明
1	VCC / VDD	电源输入，工作电压 4.5V~24V
2	DO	互补输出 A（集电极开路）
3	DOB	互补输出 B（集电极开路）
4	GND	电源地，共地参考
二、工作逻辑（互补双输出）
...
![](2026-07-23-20-45-32.png)

1 脚接供电正极，4 脚接电源负极；

DO、DOB 分别接电机两相线圈驱动电阻，自动交替导通两相绕组，实现电机持续旋转；

输出为开漏结构，必须外接上拉电阻才能输出标准高低电平给单片机 IO。
