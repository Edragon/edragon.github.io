...
1.  **Contact us (optionally):** Email info@electrodragon.com with the details of the custom items you need.

2.  **Add Value:** Add the equivalent value of your custom order to your cart using this item link.

https://www.electrodragon.com/product/custom-order/
...
4.  **Forgot the Note?** If you forget to add the note during checkout, please email the details to us in the early.
