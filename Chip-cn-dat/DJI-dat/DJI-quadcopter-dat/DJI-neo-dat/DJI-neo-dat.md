...
- Sport mode max climb 3 m/s, manual max speed 16 m/s — capable but not aggressive
- Sits in the same low-ratio "efficiency-first" band as the Flip (~2-2.5:1), far below FPV racers (5-8:1)

> Note: ~2.2-2.5:1 is a community estimate; the official specs page does not list it. The Neo is a 2S platform with noticeably less power margin than the 4S Flip.
