// ITDB02_Graph16_Demo_Widescreen (C)2010 Henning Karlsen
...
//ITDB02 myGLCD(19,18,17,16,ASPECT_16x9);

// Uncomment the next line for the ITDB02 Mega Shield
ITDB02 myGLCD(38,39,40,41,ASPECT_16x9);
...
// Clear the screen and draw the frame
  ...
  myGLCD.print("*** ITDB02 - 3.2\" 400x240 Color Display ***", CENTER, 1);
  myGLCD.setColor(255, 128, 128);
  myGLCD.setBackColor(64, 64, 64);
  myGLCD.print("H.Karlsen", LEFT, 227);
  myGLCD.print("(C)2010", RIGHT, 227);
  myGLCD.setColor(255,255,0);
  myGLCD.print("Widescreen Landscape Mode", CENTER, 227);
