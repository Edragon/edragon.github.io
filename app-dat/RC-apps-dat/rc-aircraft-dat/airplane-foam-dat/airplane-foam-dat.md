...
很多人误以为 EPP 泡沫“软、不够高级、像玩具”，无法用于远航，但实际上现代高性能 EPP 泡沫机在设计上完全能兼顾**耐摔**与**高效滑翔**。

以下是 EPP 泡沫机能够胜任滑翔和远航的核心原因：

### 1. 为什么 EPP 泡沫机适合远航？（核心优势）
* **超高负载能力（Payload Capacity）：** 远航需要装载大容量电池（如 4S/6S 锂电池）、GPS、飞控、图传发射端和高清相机。EPP 泡沫材质密度低、浮力大，可以用极轻的自身重量撑起很大的内部舱室和沉重的电池。
* **抗摔与容错率高：** 远航往往去野外、山地或陌生空域，降落时难免遇到硬着陆、草丛藏石或“炸机”。EPP 的高韧性能让飞机在遭遇撞击时通过形变吸收能量，通常粘一粘就能原地复活，这对于长途拉距探险的玩家来说至关重要。
* **低翼载与高升阻比：** 许多远航 EPP 飞机采用**大展弦比（Wingspan）**设计（机翼细长），能提供极佳的升阻比，非常利于长时间滞空和滑翔。

### 2. 经典的远航 EPP 泡沫机代表
在航模圈，有几款极其著名的 EPP 远航/滑翔机长青树：
* **ZOHD 系列（如 Dart、Dolphin、Nano Talon）：** 机身均采用高密度 EPP 材质，部分型号带有前置或后置电机，流线型极佳，是兼顾速度与远航的代表。
* **Reptile Dragon / S800 飞翼：** 采用 EPP 材质的无尾翼飞翼设计，抗风性好，飞行效率高，非常适合挂载大电池进行超视距 FPV 飞行。
* **Bixler / EasyStar 系列动力滑翔机：** 经典的 EPP 上单翼电机滑翔机，有着极大的滑翔比，关掉油门可以靠微弱的气流飘很久。

### 3. EPP 远航机实现超长续航的秘诀
1. **电池与重量平衡：** 远航机通常会选择大容量锂离子电池（如 18650 或 21700 动力电芯制作的电池组），配合高效率的无刷电机和低KV值、大尺寸的折叠螺旋桨，实现极低的巡航电流（例如巡航电流只有 3A-5A）。
2. **搭配飞控实现 Auto Loiter/RTH：** 远航机通常会加装 ArduPilot 或 iNav 飞控。当飞远后信号变弱或电量过低时，一键触发 **RTH（Return-to-Home，自动返航）**，飞机会自主平稳飞回起飞点。

---

### 💡 总结
EPP 泡沫机不仅能滑翔，而且是**玩长距离 FPV 远航性价比最高、最让人安心的选择**。很多资深玩家虽然玩过昂贵的碳纤维/玻璃钢复合材料滑翔机，但出门远航时依然会首选 EPP，因为“皮实耐操”在野外飞行中永远是第一位的。
